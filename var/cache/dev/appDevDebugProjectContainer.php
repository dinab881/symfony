...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'mastering', 'user' => 'root', 'password' => 'pass', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9630090026b55bf845c6f9fbd836d3b64255520dd9827fbe8e8d022da58da650');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('liona.reed2@gmail.com');
        $a->setPassword('bimiK675Yth');
        $a->setAuthMode('login');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58bdd3882d4126.97137825')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'mastering',
            'database_user' => 'root',
            'database_password' => 'pass',
            'mailer_transport' => 'gmail',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'liona.reed2@gmail.com',
            'mailer_password' => 'bimiK675Yth',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'liona.reed2@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'bimiK675Yth',
